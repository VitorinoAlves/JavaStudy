package br.com.calves.resources;

import br.com.calves.domain.Venda;
import br.com.calves.dto.VendaDTO;
import br.com.calves.usecase.BuscaVenda;
import br.com.calves.usecase.CadastroVenda;
...
public class VendasResources {
    ...
    @Autowired
    public VendasResources(BuscaVenda buscaVenda, CadastroVenda cadastroVenda) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Requisição malformada ou erro se sintaxe",
                content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, examples = @ExampleObject(value = "BAD_REQUEST"))),
            @ApiResponse(responseCode = "500", description = "Foi gerada umaexceção",
